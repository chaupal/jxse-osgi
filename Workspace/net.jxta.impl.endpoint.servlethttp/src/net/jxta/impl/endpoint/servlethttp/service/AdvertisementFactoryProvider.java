package net.jxta.impl.endpoint.servlethttp.service;
...
public class AdvertisementFactoryProvider implements IAdvertisementFactoryProvider{
	...
	public static final String S_JXSE_ADVERTISEMENT_FACTORY = "net.jxta.impl.endpoint.servlethttp.advertisment.factory.service";
