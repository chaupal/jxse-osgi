...
public class NettyTestUtils {
    ...
    public static void assertEquals(ChannelBuffer expected, ChannelBuffer actual) {
        if(expected.readableBytes() != actual.readableBytes()) {
            Assert.fail("channel buffers have differing readable sizes" + expected.readableBytes() +  actual.readableBytes());
        }
        ...
        while(expected.readable()) {
            ...
            if(expectedByte != actualByte) {
                Assert.fail("channel buffers differ at position " + position +  expectedByte + actualByte);
            }
